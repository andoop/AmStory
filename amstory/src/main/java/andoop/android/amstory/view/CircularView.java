...
public class CircularView extends RelativeLayout {
    ...
    public CircularView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            float radius = ta.getDimension(R.styleable.CircularView_radius, 0);
            topLeftRadius = ta.getDimension(R.styleable.CircularView_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.CircularView_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.CircularView_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.CircularView_bottomRightRadius, radius);
            ta.recycle();
        }
